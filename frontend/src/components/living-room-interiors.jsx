...
export default function LivingRoomInteriors() {
  ...
  // Inline image upload handler (preview only)
  ...
  async function handleSaveImage(imgId) {
    ...
    try {
      ...
      formData.append("category", "livingroom");
  ...
  // Compute visible images dynamically (always show 3 if possible)
